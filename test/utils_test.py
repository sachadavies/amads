...
from musmart.core.utils import dir2coll, hz2keynum, keynum2hz, keyname
...
class TestUntils(unittest.TestCase):
    ...
    def test_keyname(self):
        ...
        self.assertEqual(keyname([60, 61, 69]), ['C4', 'C#4', 'A4'])  # List of MIDI keys
        
        # Test list input with 'nameonly'
        self.assertEqual(keyname([60, 61, 69], detail='nameonly'), ['C', 'C#', 'A'])  # List of note names
