...
KrumhanslKessler = dict(
    ...
    major_sum=[
        0.152, 0.053, 0.083, 0.056, 0.105, 0.098,
    ...
    minor_sum=[
        0.142, 0.06, 0.079, 0.121, 0.058, 0.079,
...
KrumhanslSchmuckler = dict(
    ...
    major=[
        6.35, 2.33, 3.48, 2.33, 4.38, 4.09,
        2.52, 5.19, 2.39, 3.66, 2.29, 2.88],
    major_sum=[
        0.152, 0.056, 0.083, 0.056, 0.105, 0.098,
...
AardenEssen = dict(
    ...
    major_sum=[
        0.178, 0.001, 0.149, 0.002, 0.198, 0.114,
    ...
    minor_sum=[
        0.183, 0.007, 0.14, 0.169, 0.007, 0.144,
...
BellmanBudge = dict(
    ...
    major_sum=[
        0.168, 0.009, 0.13, 0.014, 0.135, 0.119,
    ...
    minor_sum=[
        0.182, 0.007, 0.13, 0.133, 0.011, 0.112,
...
TemperleyKostkaPayne = dict(
    ...
    major_sum=[
        0.176, 0.014, 0.115, 0.019, 0.158, 0.108,
    ...
    minor_sum=[
        0.17, 0.02, 0.113, 0.148, 0.012, 0.11,
...
Sapp = dict(
    ...
    major_sum=[
        0.222, 0.0, 0.111, 0.0, 0.111, 0.111,
        0.0, 0.222, 0.0, 0.111, 0.0, 0.111],

    minor=[
        2, 0, 1, 1, 0, 1, 0, 2, 1, 0, 1, 0],
    minor_sum=[
        0.222, 0.0, 0.111, 0.111, 0.0, 0.111,
...
Vuvan = dict(
    ...
    natural_minor=[
        5.08, 3.03, 3.73, 4.23, 3.64, 3.85,
        3.13, 5.29, 4.43, 3.95, 5.26, 3.99],
    natural_minor_sum=[
        0.102, 0.061, 0.075, 0.085, 0.073, 0.078,
        0.063, 0.107, 0.089, 0.08, 0.106, 0.08],

    harmonic_minor=[
        4.62, 2.63, 3.74, 4.23, 3.63, 3.81,
        4.15, 5.21, 4.77, 3.95, 3.79, 5.3],
    harmonic_minor_sum=[
        0.093, 0.053, 0.075, 0.085, 0.073, 0.076,
        0.083, 0.105, 0.096, 0.079, 0.076, 0.106],

    melodic_minor=[
        4.75, 3.26, 3.76, 4.46, 3.49, 4.09,
        3.67, 5.08, 4.14, 4.43, 4.51, 4.91],
    melodic_minor_sum=[
        0.094, 0.064, 0.074, 0.088, 0.069, 0.081,
...
deClerqTemperley = dict(
    ...
    roots=[
        0.328, 0.005, 0.036, 0.026, 0.019, 0.226,
...
TemperleyDeClerq = dict(
    ...
    melody_major=[
        0.223, 0.001, 0.158, 0.015, 0.194, 0.071,
        0.002, 0.169, 0.003, 0.119, 0.008, 0.035],

    melody_minor=[
        0.317, 0.001, 0.09, 0.159, 0.046, 0.097,
        0.007, 0.131, 0.009, 0.047, 0.087, 0.009],

    harmony_major=[
        0.231, 0.002, 0.091, 0.004, 0.149, 0.111,
        0.004, 0.193, 0.004, 0.126, 0.011, 0.076],

    harmony_minor=[
        0.202, 0.006, 0.102, 0.127, 0.047, 0.113,
...
PrinceSchumuckler = dict(
    ...
    downbeat_major=[
        1, 0.088610811, 0.569205361, 0.140888014, 0.615384615, 0.481864956,
        0.140888014, 0.976815092, 0.156831608, 0.433398971, 0.122721209, 0.427237502],
    downbeat_major_sum=[
        0.194, 0.017, 0.11, 0.027, 0.119, 0.093,
        0.027, 0.19, 0.03, 0.084, 0.024, 0.083],

    downbeat_minor=[
        1, 0.127885863, 0.516472114, 0.640207523, 0.174189364, 0.537483787,
        0.160311284, 0.989883268, 0.426588846, 0.172114137, 0.430350195, 0.286381323],
    downbeat_minor_sum=[
        0.183, 0.023, 0.095, 0.117, 0.032, 0.098,
        0.029, 0.181, 0.078, 0.032, 0.079, 0.052],

    all_beats_major=[
        0.919356471, 0.114927991, 0.729198287, 0.144709771, 0.697021822, 0.525970522,
        0.214762724, 1, 0.156143546, 0.542952545, 0.142399406, 0.541215555],
    all_beats_major_sum=[
        0.16, 0.02, 0.127, 0.025, 0.122, 0.092,
        0.037, 0.175, 0.027, 0.095, 0.025, 0.094],

    all_beats_minor=[

        0.874192439, 0.150655606, 0.637256776, 0.697274361, 0.162238618, 0.62471807,
        0.167131771, 1, 0.47788524, 0.212622807, 0.467754884, 0.298711724],
    all_beats_minor_sum=[
        0.151, 0.026, 0.11, 0.121, 0.028, 0.108,
...
QuinnWhite = dict(
    ...
    majorAll=[
        0.172, 0.014, 0.107, 0.011, 0.160, 0.099, 0.018, 0.231, 0.017, 0.059, 0.016, 0.093],
    major6=[
        0.166, 0.018, 0.096, 0.014, 0.170, 0.085, 0.019, 0.240, 0.019, 0.062, 0.020, 0.091],
    major1=[
        0.173, 0.016, 0.103, 0.014, 0.165, 0.091, 0.020, 0.234, 0.018, 0.055, 0.018, 0.093],
    major8=[
        0.171, 0.014, 0.099, 0.013, 0.164, 0.099, 0.018, 0.235, 0.016, 0.064, 0.015, 0.093],
    major3=[
        0.173, 0.015, 0.108, 0.011, 0.160, 0.098, 0.019, 0.231, 0.016, 0.059, 0.015, 0.094],
    major10=[
        0.169, 0.016, 0.107, 0.013, 0.158, 0.099, 0.020, 0.230, 0.017, 0.060, 0.017, 0.096],
    major5=[
        0.173, 0.014, 0.108, 0.009, 0.161, 0.096, 0.018, 0.231, 0.016, 0.063, 0.016, 0.095],
    major0=[
        0.174, 0.014, 0.112, 0.010, 0.160, 0.100, 0.016, 0.230, 0.015, 0.058, 0.016, 0.096],
    major7=[
        0.175, 0.013, 0.108, 0.011, 0.156, 0.102, 0.017, 0.233, 0.016, 0.058, 0.019, 0.091],
    major2=[
        0.175, 0.013, 0.113, 0.010, 0.155, 0.102, 0.017, 0.227, 0.017, 0.061, 0.015, 0.094],
    major9=[
        0.174, 0.014, 0.108, 0.012, 0.160, 0.101, 0.017, 0.232, 0.018, 0.059, 0.014, 0.093],
    major4=[
        0.171, 0.013, 0.108, 0.010, 0.161, 0.106, 0.015, 0.229, 0.019, 0.059, 0.016, 0.092],
    major11=[
        0.167, 0.014, 0.106, 0.014, 0.164, 0.100, 0.018, 0.233, 0.021, 0.054, 0.020, 0.089],

    minorAll=[
        0.170, 0.012, 0.115, 0.149, 0.013, 0.095, 0.027, 0.211, 0.074, 0.024, 0.026, 0.085],
    minor6=[
        0.172, 0.013, 0.109, 0.149, 0.014, 0.091, 0.029, 0.215, 0.075, 0.025, 0.028, 0.081],
    minor1=[
        0.168, 0.014, 0.112, 0.152, 0.014, 0.093, 0.028, 0.212, 0.078, 0.022, 0.026, 0.082],
    minor8=[
        0.168, 0.014, 0.106, 0.151, 0.014, 0.093, 0.028, 0.212, 0.076, 0.022, 0.030, 0.085],
    minor3=[
        0.168, 0.014, 0.111, 0.152, 0.015, 0.087, 0.032, 0.213, 0.073, 0.025, 0.027, 0.082],
    minor10=[
        0.164, 0.011, 0.113, 0.150, 0.014, 0.095, 0.033, 0.205, 0.078, 0.027, 0.027, 0.083],
    minor5=[
        0.167, 0.011, 0.117, 0.141, 0.012, 0.093, 0.026, 0.217, 0.077, 0.024, 0.025, 0.089],
    minor0=[
        0.170, 0.012, 0.118, 0.141, 0.011, 0.098, 0.026, 0.212, 0.074, 0.024, 0.023, 0.091],
    minor7=[
        0.174, 0.011, 0.116, 0.152, 0.014, 0.094, 0.028, 0.208, 0.069, 0.027, 0.026, 0.081],
    minor2=[
        0.172, 0.010, 0.118, 0.158, 0.012, 0.092, 0.023, 0.211, 0.067, 0.027, 0.027, 0.084],
    minor9=[
        0.175, 0.010, 0.114, 0.149, 0.012, 0.096, 0.025, 0.217, 0.073, 0.021, 0.026, 0.083],
    minor4=[
        0.174, 0.012, 0.114, 0.149, 0.013, 0.098, 0.029, 0.202, 0.076, 0.025, 0.023, 0.087],
    minor11=[
        0.164, 0.012, 0.120, 0.144, 0.013, 0.102, 0.024, 0.208, 0.074, 0.022, 0.028, 0.088],
)
VuvanHughes = dict(
    name="VuvanHughes",
    ...
    classical=[
        5.38, 2.65, 3.39, 3.01, 3.62, 3.96,
        2.83, 4.93, 2.9, 3.38, 2.91, 3.03],
    classical_sum=[
        0.128, 0.063, 0.081, 0.072, 0.086, 0.094,
        0.067, 0.117, 0.069, 0.08, 0.069, 0.072],

    rock=[
        5.34, 3.33, 3.73, 3.39, 3.95, 3.99,
        2.82, 4.54, 2.9, 3.21, 2.88, 2.71],
    rock_sum=[
        0.125, 0.078, 0.087, 0.079, 0.092, 0.093,
